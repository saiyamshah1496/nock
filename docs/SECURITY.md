...
- Free modes (Bring your own estate, Sync estate yourself) keep estate generation and storage on your own runner/repo. The estate contains table sizes, Postgres version, and a governance catalogue (columns, constraints, indexes). It does NOT contain:
  - Table row data
  - Default expression text
  - CHECK/index expressions or predicates
